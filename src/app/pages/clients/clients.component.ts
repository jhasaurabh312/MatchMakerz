...
export class ClientsComponent implements OnInit {
    ...
    SerachMyClients() {
        ...
        this.http.get('http://matchmakerz.in/api/v1/matchmaker/searchclient?search=' + this.SearchClient.value["search"], {
            headers: headers
        }).subscribe((response) => {
            ...
            for (let i = 0; i < l; i++) {
                ...
                if (this.staticProductDetail[i].manglik == 0 || this.staticProductDetail[i].manglik == '0' || this.staticProductDetail[i].manglik === 0 || this.staticProductDetail[i].manglik === '0')
                    this.staticProductDetail[i].manglik = 'Non-Manglik';
                else if (this.staticProductDetail[i].manglik == 1 || this.staticProductDetail[i].manglik == '1' || this.staticProductDetail[i].manglik === 1 || this.staticProductDetail[i].manglik === '1')
                    this.staticProductDetail[i].manglik = 'Manglik';
                else if (this.staticProductDetail[i].manglik == 2 || this.staticProductDetail[i].manglik == '2' || this.staticProductDetail[i].manglik === 2 || this.staticProductDetail[i].manglik === '2')
    ...
    ngOnInit() {
        ...
        this.http.get('http://matchmakerz.in/api/v1/client/list?id=99999999999', {
            headers: headers
        }).subscribe((response) => {
            this.staticProductDetail = response;
            ...
            for (let i = 0; i < l; i++) {
                ...
                console.log(this.staticProductDetail[i].manglik + " " + this.staticProductDetail[i].name)
                ...
                console.log(this.staticProductDetail[i].manglik === '2')
                console.log(this.staticProductDetail[i].manglik == '2')
                console.log(this.staticProductDetail[i].manglik === 2)
                console.log(this.staticProductDetail[i].manglik ==2)
                console.log(this.staticProductDetail[i].manglik)
                  console.log(typeof(this.staticProductDetail[i].manglik));
        ...
        this.http.get('http://matchmakerz.in/api/v1/client/notifications', {
            headers: headers
    ...
    GetMore() {
        ...
        return this.http.get('http://matchmakerz.in/api/v1/client/list?id=' + localStorage.getItem('lastClientId'), {
            headers: headers
        }).subscribe((load_response) => {
            ...
            for (let i = 0; i < this.staticProductDetail.length; i++){
                ...
                console.log(this.staticProductDetail[i].manglik === 0 + " " + this.staticProductDetail[i].name);
