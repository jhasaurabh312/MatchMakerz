        ...
        this.http.get('http://matchmakerz.in/api/v1/client/client-preferences?id=' + this.route.snapshot.queryParamMap.get('id'), {
            ...
            console.log(this.client_pref)
                this.AddClientEducationalDetails = this._formBuilder.group({
                    ...
                    'min_income': [this.client_pref.min_income],
                    'max_income': [(this.client_pref.max_income)],
                   'min_height': [this.client_pref.min_height!==null ? (this.client_pref.min_height).toString() : ''],
                    'max_height': [this.client_pref.max_height!==null ? (this.client_pref.max_height).toString():''],
                    'marital_status': [this.client_pref.marital_status!==null ? (this.client_pref.marital_status).toString():''],
                    'manglik': [this.client_pref.manglik!==null ? (this.client_pref.manglik).toString():''],
                    'food_choice': [this.client_pref.food_choice!==null ? (this.client_pref.food_choice).toString():''],
                    'occupation': [this.client_pref.occupation!==null ? (this.client_pref.occupation).toString():''],
                    'citizenship': [this.client_pref.citizenship!==null ? (this.client_pref.citizenship).toString():''],
